...
from ticket_pilot.security import current_user_kind, require_authenticated_username, validate_csrf_header
from ticket_pilot.services.changelog import current_changelog_entry, load_changelog_entries
from ticket_pilot.services.help_assistant import (
    MAX_HELP_QUESTION_CHARS,
    HelpAssistantError,
    answer_help_question,
)
from ticket_pilot.services.support_contact import append_help_contact_footer
