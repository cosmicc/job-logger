...
from ticket_pilot.services.passkeys import passkey_credential_count_for_user
...
def _active_time_payload(job: object) -> dict[str, object]:
    ...
    return {
        ...
        "minimum_duration_minutes": minimum_time_entry_duration_minutes(job.work_location),
