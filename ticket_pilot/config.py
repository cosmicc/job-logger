...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        database_url=os.getenv(
            "DATABASE_URL",
            "postgresql+psycopg://ticket_pilot:ticket_pilot_password@db:5432/ticket_pilot",
        ),
        ...
        mail_from_email=(os.getenv("MAIL_FROM_EMAIL", "ticketpilot@example.com").strip() or "ticketpilot@example.com"),
        mail_from_name=(os.getenv("MAIL_FROM_NAME", "TicketPilot").strip() or "TicketPilot"),
