...
from ticket_pilot.models import PasswordResetRequestCounter, PasswordResetToken, WebUser
...
from ticket_pilot.services.login_failures import enforcement_client_ip_from_request
from ticket_pilot.services.session_control import invalidate_web_user_sessions
from ticket_pilot.services.users import WebUserError, change_web_user_password, normalize_optional_email
from ticket_pilot.time_utils import now_utc
