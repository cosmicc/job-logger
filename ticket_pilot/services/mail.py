"""Mail delivery helpers for TicketPilot account workflows."""
...
PASSWORD_RESET_SUBJECT = "Reset your TicketPilot password"
WELCOME_EMAIL_SUBJECT = "Welcome to TicketPilot"
...
def _password_reset_body(*, reset_url: str, application_settings: Settings) -> str:
    ...
    return (
        "A password reset was requested for your TicketPilot account.\n\n"
...
def build_welcome_email_body(
    *,
    ...
    return (
        ...
        "Open TicketPilot here:\n"
        f"{app_url}\n\n"
        "Sign in with your username:\n"
        f"{username.strip()}\n\n"
        "Use the temporary password provided by your administrator. After you sign in, "
        "TicketPilot will ask you to create a new password before continuing.\n\n"
        "TicketPilot can be used from a web browser on a computer or installed on your mobile device. "
        ...
        "To install TicketPilot on your phone:\n\n"
        "iPhone or iPad:\n"
        "1. Open the TicketPilot link in Safari.\n"
        "2. Tap the Share button.\n"
        "3. Tap Add to Home Screen.\n"
        "4. Tap Add.\n\n"
        "Android:\n"
        "1. Open the TicketPilot link in Chrome.\n"
