...
from ticket_pilot.time_utils import ensure_utc, format_autotask_datetime, local_date_for, local_day_bounds_utc, now_utc, rounded_duration_minutes
...
AUTOTASK_ADVISORY_LOCK_NAME = "ticket_pilot.autotask.request_slots"
    ...
    def _tips_for_remote_failure(self, exc: Exception, failed_operation: str | None = None) -> tuple[str, ...]:
        ...
        if "adequate permissions" in error_message:
            return (
                ...
                "Retest the debug page after changing Autotask permissions; no TicketPilot secret changes are needed for this failure.",
