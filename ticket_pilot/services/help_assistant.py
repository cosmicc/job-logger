...
SUPPORT_CONTEXT_GLOBS = (
    ...
    "ticket_pilot/services/*.py",
    "ticket_pilot/templates/*.html",
    "ticket_pilot/static/*.js",
)
STOP_WORDS = {
    "about",
    "after",
...
BUILT_IN_HELP_GUARDRAILS = """You are TicketPilot Help for authenticated end users.
Answer only questions about using the TicketPilot application.
...
or implementation details, say you can only help with using TicketPilot and that
...
def _build_help_chat_input(question: str, source_context: str) -> str:
    ...
    return (
        "Answer the authenticated TicketPilot user's help question using the "
...
def _build_help_system_instructions(application_settings: Settings) -> str:
    ...
    return (
        ...
        "Configured TicketPilot help instructions:\n"
    ...
    *,
    ...
    if _looks_like_internal_question(normalized_question):
        ...
        return HelpAssistantResult(
            answer_text=(
                "I can help with using TicketPilot, but not with source code, "
