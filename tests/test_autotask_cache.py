...
def test_ticket_note_context_filter_removes_system_generated_notes() -> None:
    """Ticket context overlays should not expose Autotask system-generated notes."""

    notes = [
        AutotaskTicketNote(
            note_id=91001,
            title="Workflow Rule: Ticket status changed",
            description="Generated by an Autotask workflow.",
            note_type=None,
        ),
        AutotaskTicketNote(
            note_id=91002,
            title="Service desk sent notification",
            description="Generated by a service desk notification.",
            note_type="Service Desk Notification",
        ),
        AutotaskTicketNote(
            note_id=91003,
